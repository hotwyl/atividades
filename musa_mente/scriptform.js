...
function enviarFinal(){
    ...
    if (validarEmail == false){
        ...
        window.location.replace('https://musadamente-com-br.umbler.net/wp-content/themes/epico/insertsql.php?at='+ window.at + '&af=' + window.af + '&pe=' + window.pe + '&ar=' + window.ar + '&de=' + window.de + '&he=' + window.he + '&email=' + window.email)
