<!-- <center>
<h1> Bootstrap </h1>
<p> <a href="/calculadora/materialize"> Materialize </a> </p>
</center> -->
...
<body>
	...
	<?php
		...
		<footer class="mastfoot mt-auto bg-light">
			<div class="container inner">
				<center> <span class="text-muted">&copy;HOTWYL | WILLFROMBRASIL </span> -> <a href="/calculadora/materialize"> Materialize </a></center>
			</div> 
		</footer>
