...
echo json_encode([
					"loto_facil1" => busca_dados_lf($sorteio_lf, $aposta_lf),
					"loto_facil2" => busca_dados_lf($sorteio_lf, $sorteio_lf),
					"loto_mania1" => busca_dados_lm($sorteio_lm, $aposta_lm),
					"loto_mania2" => busca_dados_lm($sorteio_lm, $sorteio_lm),
				]);
